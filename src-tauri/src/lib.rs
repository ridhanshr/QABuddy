...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::jira::update_test_run_assignee,
            ...
            commands::db::get_test_plans_by_project_prefix,
            commands::db::check_test_plans_in_db,
            commands::db::reconcile_test_plans_deleted,
            commands::db::save_test_executions,
            commands::db::check_test_executions_in_db,
            commands::db::reconcile_test_executions_deleted,
            ...
            commands::db::check_defects_in_db,
            commands::db::get_my_uqa_projects,
            commands::db::get_my_test_executions,
            commands::db::get_te_by_project_prefix,
            ...
            commands::db::update_test_case_assignee,
